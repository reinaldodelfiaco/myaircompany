...
opanel('Editar informações da empresa:');
...
row();
col(3);
form_checkbox('Fornecedor?', 'fornecedor', 1, $empresa->fornecedor);
cdiv();
col(3);
form_checkbox('Agência?', 'agencia', 1, $empresa->agencia);
cdiv();
col(3);
form_checkbox('Cliente?', 'cliente', 1, $empresa->cliente);
cdiv();
col(3);
form_checkbox('Transportadora?', 'transportadora', 1, $empresa->transportadora);
cdiv();
cdiv();
hr();
...
row();
    col(6);
        form_text_input('País', 'pais', '','','', $empresa->pais);
    cdiv();
    col(6);
        form_text_input('PASSAPORT', 'passaport', '','','',$empresa->passaport);
    cdiv();
cdiv();
