<?php 
    ...
    br();
    ptable('Chefias (Comissários)');
    datatable('chefias', ['Nome', 'Telefone', 'Email', 'Status'], ['nome', 'telefone', 'email', 'status'], $chefias, ['carteira' => 'chefias/adicionar_carteira_comissario?id','editar' => 'chefias/editar_chefias_comissarios?id', 'deletar' => 'chefias/deletar_comissarios?id']);
    cpanel();
    
    omodal('Novo comissário', 'add', 'modal-lg');
    
    form_open('chefias/comissarios');
